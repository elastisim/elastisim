...
IdleTask::IdleTask(const std::string& name, const std::string& iterations, bool synchronized,
				   ...
				   VectorPattern delayPattern) : DelayTask(name, iterations, synchronized, delays, delayPattern) {}

IdleTask::IdleTask(const std::string& name, const std::string& iterations, bool synchronized,
				   const std::string& delayModel,
				   VectorPattern delayPattern) : DelayTask(name, iterations, synchronized, delayModel, delayPattern) {}

void IdleTask::execute(const Node* node, const Job* job,
